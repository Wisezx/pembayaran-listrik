...
<div class="max-w-3xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
    <h1 class="text-3xl font-bold text-white mb-6">Tambah Akun Petugas</h1>
    ...
    <form action="{{ route('petugas.store') }}" method="POST" class="bg-white p-8 rounded-xl shadow-lg space-y-6 ring-1 ring-gray-200">
        @csrf
        ...
        {{-- Sembunyikan input role kalau default-nya "petugas" --}}
