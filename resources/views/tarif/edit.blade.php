...
<div class="max-w-2xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
    <h1 class="text-3xl font-bold text-white mb-6">Edit Data Tarif Listrik</h1>
    ...
    <form action="{{ route('tarif.update', $tarif->id) }}" method="POST" class="bg-white p-8 rounded-xl shadow-lg space-y-6 ring-1 ring-gray-200">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            <input type="text" name="Jenis_Plg" value="{{ old('Jenis_Plg', $tarif->Jenis_Plg) }}" required
        ...
        <div>
            ...
            <div class="relative">
                <input type="number" step="0.01" name="tarifkwh" value="{{ old('tarifkwh', $tarif->tarifkwh) }}" required
        ...
        <div>
            ...
            <div class="relative">
                <input type="number" step="0.01" name="biayabeban" value="{{ old('biayabeban', $tarif->biayabeban) }}" required
